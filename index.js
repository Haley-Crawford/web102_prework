...
const str = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames} games. 
    Currently, ${unfundedCount > 1 ? unfundedCount + ' games remain' : unfundedCount + ' game remains'} unfunded.
    We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const displayStr = document.createElement('p')
displayStr.innerHTML = str
